...
public  class Q5b{
    public int num_Battery_Replacements(int[][] serviceCenters, int targetMiles, int startChargeCapacity) {
        int count = 0;
    ...
    public static void main(String[] args) {
        ...
        int finalAnswer=question1.num_Battery_Replacements(serviceCenterList,100,10);

...
class List_of_Ancestor {
    ...
    public int[] get_Coprime(int[] nums, int[][] edges) {
    ...
    public static void main(String[] args) {
        ...
        List_of_Ancestor listOfAncestors = new List_of_Ancestor();
        int[] ans = listOfAncestors.get_Coprime(values,edges);
